...
const FormulaHints = () => {
    return (
        <div className="w-1/5 [@media(min-width:1440px)]:fixed top-35 left-4 h-fit bg-[#F0F4F8] shadow-md rounded-2xl p-4 overflow-y-auto max-h-[80vh]">
            ...
            <div className="text-md space-y-2">
                <div className="mb-2">
                    ...
                    <p>
                        AsciiMath:{' '}
                        <code className="bg-gray-200 px-1 rounded">`a/b`</code>
                    </p>
                </div>
                ...
                <div className="mb-2">
                    ...
                    <p>
                        AsciiMath:{' '}
                        <code className="bg-gray-200 px-1 rounded">`x^2`</code>
                    </p>
                    <div className="flex gap-2">
                ...
                <div className="mb-2">
                    ...
                    <p>
                        AsciiMath:{' '}
                        <code className="bg-gray-200 px-1 rounded">`x_1`</code>
                    </p>
                </div>
                ...
                <div className="mb-2">
                    ...
                    <p>
                        AsciiMath:{' '}
                        <code className="bg-gray-200 px-1 rounded">`oo`</code>
                    </p>
                </div>
                ...
                <div className="mb-2">
                    ...
                    <p>
                        AsciiMath:{' '}
                        <code className="bg-gray-200 px-1 rounded">`pi`</code>
                    </p>
                </div>
                ...
                <div>
                    ...
                    <p>
                        ...
                        ,{' '}
                        <code className="bg-gray-200 px-1 rounded">`beta`</code>
                        ,{' '}
                        <code className="bg-gray-200 px-1 rounded">
                            `gamma`
                        </code>{' '}
